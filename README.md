...
Note that while the scaling values are limited to a range between 0.5 and 1.0, the offset is not limited, for cases where the empty space at the top and left of the projection can be filled up with your content.
